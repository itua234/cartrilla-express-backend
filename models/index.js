...
db.models.UserVerification = require('./user_verification')(sequelize, Sequelize.DataTypes);
db.models.UserProfile = require('./user_profile')(sequelize, Sequelize.DataTypes);
db.models.PasswordReset = require('./password_reset')(sequelize, Sequelize.DataTypes);
...
db.models.Wishlist = require('./wishlist')(sequelize, Sequelize.DataTypes);
